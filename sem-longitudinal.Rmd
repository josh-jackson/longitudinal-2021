...
```{r, echo = FALSE}
  ...
  tvc1 <- rnorm(n = 246, 0,1)
  tvc2 <- rnorm(n = 246, 0,1)
  tvc3 <- rnorm(n = 246, 0,1)
  
alcohol.wide <- cbind(alcohol.wide,tvc1 )  
alcohol.wide <- cbind(alcohol.wide,tvc2 )
alcohol.wide <- cbind(alcohol.wide,tvc3 )
```
