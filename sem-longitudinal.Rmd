...
Falling under this designation is the cross-lagged panel model (clpm). The concerns of clpms are assuaged when you have more than two assessment points, you measure your variables latently, and/or you account for mean structure.
...
### 2.a Longitudinal Cross lagged panel model (clpm)
...
### 2.b Longitudinal mediation model
...
For all of the growth models this semester we have focused only on a single outcome. 
